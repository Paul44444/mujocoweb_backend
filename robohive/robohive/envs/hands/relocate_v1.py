...
class RelocateEnvV1(env_base.MujocoEnv):
    ...
    def reset(self, reset_qpos=None, reset_qvel=None, **kwargs):
        ...
        self.sim.model.body_pos[self.obj_bid,0] = self.np_random.uniform(low=-0.15, high=0.15)#-0.15
        self.sim.model.body_pos[self.obj_bid,1] = self.np_random.uniform(low=-0.15, high=0.3)#0.1
