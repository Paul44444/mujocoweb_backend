...
from mjrlpaul.utils.optimize_model import fit_data

import pickle

class MLPBaseline:
    def __init__(self, env, env_spec, inp_dim=None, inp='obs', learn_rate=1e-3, reg_coef=0.0,
                 batch_size=64, epochs=1, use_gpu=False, hidden_sizes=(128, 128)):
        self.n = inp_dim if inp_dim is not None else env.observation_space.shape[0]#env_spec.observation_dim
