import numpy as np
from mjrlpaul.utils.fc_network import FCNetwork
import torch
...
class MLP:
    def __init__(self, env, env_spec,
        ...
        """
        self.n = np.min([env.observation_space.shape[0], 39])#env_spec.observation_dim  # number of states
        self.m = env.action_space.shape[0]#env_spec.action_dim  # number of actions
    ...
    def get_action(self, observation):
        ...
        mean = self.model(self.obs_var[:, :self.n]).data.numpy().ravel()
